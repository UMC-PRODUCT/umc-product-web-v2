...
export const ABOUT_RECRUIT = {
  ...
  parts: [
    ...
    },
    {
      id: "design",
      tabLabel: "Design",
      // 시안 주석: "UMC 공식 표기명과 통일하여 Product Design -> Design".
      titleLines: ["Design"],
      // TODO: (미확정) 시안 임시 문구
      description:
...
export const ABOUT_POSSIBILITY = {
  ...
  // 시안 주석에 디자이너가 대체 문구를 달아 둬서 그대로 반영했다.
  // 시안 본문의 "(어필하는 설명 필요)" 임시 문구는 쓰지 않는다.
  description:
    "매칭된 팀원들과 함께 실제 시장에 즉시 런칭할 수 있는 완성도 높은 서비스를 구축해요",
  stats: [
    { label: "누적 활동 회원 수", value: "4000", unit: "명" },
    { label: "매 기수 평균 지원자 수", value: "1500", unit: "명" },
    { label: "누적 프로젝트 수", value: "600", unit: "개" },
  ],
  // 시안 주석의 "문장별로 마침표 추가 제안드립니다" 를 반영해 마침표를 붙였다.
  values: [
    {
      keyword: "성장",
      lines: [
        "실제 서비스를 기획하고 개발하며, 실무에서 필요한 역량을 기를 수 있어요.",
        "스터디 진행 후 프로젝트에 참여하므로, 열정만 있다면 누구나 도전할 수 있어요.",
      ],
    },
    {
      keyword: "협업",
      lines: [
        "모든 파트원이 동등한 기회를 갖고 자신의 아이디어를 실현할 수 있어요.",
        "수평적인 문화 속에서 자유롭게 의견을 나누며 협업의 경험을 쌓아요.",
      ],
    },
    {
      // 시안 본문은 미확정 메모였고, 주석의 디자이너 제안 문구를 썼다.
      keyword: "연결",
      lines: [
        "함께 치열하게 고민하고 문제를 해결하는 과정 속에서,",
...
export const ABOUT_INTRO = {
  eyebrow: "ABOUT UMC",
  // 시안에서 줄바꿈이 지정된 헤드라인이라 줄 단위로 나눠 둔다.
  headlineLines: [
    "기획자, 디자이너, 개발자가",
    "함께 아이디어를 현실로 만드는 대학생 개발 연합 동아리입니다",
  ],
  // TODO: (미확정) 시안 임시 문구
  description:
...
// 히어로와 하단 CTA 가 같은 문장을 쓴다. 한쪽만 고치면 두 곳이 어긋난다.
// 시안 주석의 "기획부터 개발까지 -> 기획부터 런칭까지" 제안을 반영했다.
const TAGLINE =
  "기획부터 런칭까지 가능한 대학생 IT 창업 연합 동아리, 새로운 가능성을 UMC에서"

export const ABOUT_HERO = {
  eyebrow: EYEBROW,
  // headline 은 텍스트가 아니라 벡터(BreakTheRules)로 그린다. 대체 텍스트로만 쓴다.
...
export const ABOUT_CLOSING = {
  ...
  // 노드 12836:123273. 에셋이 들어오면 텍스트 대신 그 컴포넌트로 교체한다.
  headline: "UMC 11th",
  description: TAGLINE,
  ctaLabel: "11기 지원하기",
} as const
