  ...
  return (
    <section className="flex flex-col items-center gap-6.5 pt-75 pb-40">
      <div className="flex w-full flex-col items-center gap-3 md:gap-6.5">
        ...
        <p className="text-teal-gray-400 xs:text-[14px] font-suit w-full pt-0.5 pb-4.5 text-center text-base leading-6 font-light tracking-[-0.48px] md:text-[22px] md:leading-7 md:tracking-[-0.66px] xl:text-2xl xl:tracking-[-0.72px]">
