                ...
                >
                  <div className="flex w-[7.625rem] items-center justify-between">
                    ...
                    <div className="flex items-center gap-0.5">
                      <span className="text-body-2-medium text-teal-gray-500 min-w-[0.5625rem] text-center tabular-nums">
                        {row.current}
                      </span>
                      <span className="text-body-2-medium text-teal-gray-500 w-[0.3125rem] text-right">
                        /
                      </span>
                      <span className="text-body-2-medium text-teal-gray-500 min-w-[0.5rem] text-center tabular-nums">
                        {row.total}
                      </span>
                    </div>
                  </div>
