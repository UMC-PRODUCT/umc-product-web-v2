  ...
  return (
    <>
      ...
      <input
        ...
        aria-invalid={!!error}
        className="border-teal-gray-150 text-body-1-regular text-teal-gray-600 h-14 w-full overflow-x-auto rounded-[12px] border px-5 py-4 outline-none aria-[invalid=true]:focus:ring-2 aria-[invalid=true]:focus:ring-teal-600"
