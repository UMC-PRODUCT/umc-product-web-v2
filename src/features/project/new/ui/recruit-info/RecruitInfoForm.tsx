  ...
  return (
    <div className="flex flex-col gap-6 pt-4">
      <div className="px-4">
        ...
        <div className="border-teal-gray-200 mx-8.5 flex flex-col gap-8 border-b pt-6 pb-10">
          {ROLES.map(({ key, label, stacks }) => (
            <div
              key={key}
              className="flex min-w-0 flex-row flex-wrap items-center gap-6"
            >
        ...
        <div className="bg-teal-gray-100 mt-4 mb-21 flex w-full flex-row items-center gap-2 rounded-[8px] px-7 py-2.5">
          <div className="text-subtitle-3-semibold border-teal-gray-200 flex shrink-0 border-r pr-7.5 whitespace-nowrap text-teal-600">
            <span className="mr-6">총 모집 인원</span>
