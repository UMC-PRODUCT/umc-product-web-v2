...
export const segmentHeadingVariants = cva(
  "w-full text-left text-heading-5-semibold text-teal-gray-900",
)
...
export const segmentTriggerVariants = cva(
  ...
  ],
  {
    variants: {
      selected: {
        true: "border-b-teal-600 text-subtitle-3-semibold text-teal-600",
        false:
          "border-b-teal-gray-300 text-body-1-medium text-teal-gray-500 hover:border-b-teal-gray-400 hover:text-teal-gray-600",
      },
    },
