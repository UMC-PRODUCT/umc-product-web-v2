...
export const Route = createFileRoute("/test/toggle-inputs")({
  component: ToggleInputsTestPage,
})
  ...
  return (
    <main className="bg-teal-gray-50 min-h-screen w-full p-10">
      ...
      <div className="flex flex-col gap-10">
        ...
        <Section title="Radio — Unchecked 상태">
          <div className="flex items-start gap-8">
        ...
        <Section title="Radio — Checked 상태">
          <div className="flex items-start gap-8">
            <Cell label="Primary / enabled">
              <Radio
                variant="primary"
        ...
        <Section title="Checkbox — Controlled (클릭 토글)">
          <div className="flex items-start gap-8">
            <Cell label="Gray (enabled)">
        ...
        <Section title="Checkbox — Unchecked 상태">
          <div className="flex items-start gap-8">
            <Cell label="Gray / disabled">
              <Checkbox
                variant="gray"
        ...
        <Section title="Checkbox — Checked 상태">
          <div className="flex items-start gap-8">
            <Cell label="Primary / enabled">
              <Checkbox
                variant="primary"
