...
- **로고·디자인** — 프로젝트 관리 카드 로고 잘림 해결, UmcLogoFilled light variant fill을 currentColor로 수정, 푸터 브랜드명 표기를 University MakeUs Challenge로 수정
- **소개 페이지 디테일** — Painpoint 글로우를 연속 배경 레이어로 옮겨 섹션 경계 이음매 제거, FAQ 상단 오버레이 페이드 보정
